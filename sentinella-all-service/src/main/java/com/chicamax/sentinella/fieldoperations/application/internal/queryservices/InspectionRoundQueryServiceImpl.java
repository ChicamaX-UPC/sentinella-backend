...
public class InspectionRoundQueryServiceImpl implements InspectionRoundQueryService {
    ...
    @Override
    public List<InspectionRound> handle(GetRoundsByOperatorQuery query) {
        return inspectionRoundRepository.findByOperatorIdOrderByScheduledAtDesc(query.operatorId());
    }
